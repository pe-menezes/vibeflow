---
name: 'vibeflow-audit'
description: 'Audits implementation against its DoD and project patterns. Runs tests, scans the diff for destructive ops (Critical Gate), and reports PASS / PARTIAL / FAIL.'
