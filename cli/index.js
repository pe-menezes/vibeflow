...
const COPILOT_FILES = [
  ...
  { src: 'github/prompts/vibeflow-hotfix.prompt.md', dest: '.github/prompts/vibeflow-hotfix.prompt.md' },
...
const CURSOR_FILES = [
  ...
  { src: 'skills/vibeflow-hotfix/SKILL.md', dest: '.cursor/skills/vibeflow-hotfix/SKILL.md' },
