...
description: "Spec-driven development methodology for planning, speccing, and auditing features. Use when planning features, reviewing architecture, generating specs, creating prompt packs for coding agents, or auditing implementations."
---
