...
0. **Validate spec size.** Read the spec and check:
   ...
   Use the vibeflow-gen-spec skill again to split it into smaller specs before
   generating a prompt pack."
...
After implementation, use the vibeflow-audit skill with the spec to verify."
